"""
Django settings for Cinemalogs project.
...
SECRET_KEY = ')1#kur!@2-rm6bv)pv-bje%7w7w73bx-r#_he*as9la!lbqtf^'
...
WSGI_APPLICATION = 'Cinemalogs.wsgi.application'
